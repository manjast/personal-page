...
const enUi = {
  ...
  caseStudyCard: {
    ...
    metricLabels: {
      outcome: 'Outcome',
      adoption: 'Adoption and feedback signal',
      scale: 'Scale and reach',
  ...
  caseStudyDetail: {
    ...
    metricLabels: {
      ...
      adoption: 'Adoption and feedback signal',
      scale: 'Scale and reach signal',
      feedback: 'Feedback signal',
      cost: 'Cost and efficiency signal',
      other: 'Headline',
    },
  },
  schema: {
...
const srUi = {
  ...
  caseStudyCard: {
    ...
    metricLabels: {
      outcome: 'Исход',
      adoption: 'Коришћење и повратне оцене',
      scale: 'Обим и домет',
      feedback: 'Сигнал повратних информација',
      cost: 'Трошак и ефикасност',
      other: 'Наслов',
    },
  },
  caseStudyDetail: {
    ...
    metricLabels: {
      outcome: 'Показатељ исхода',
      adoption: 'Коришћење и повратне оцене',
      scale: 'Показатељ обима и домета',
      feedback: 'Сигнал повратних информација',
      cost: 'Показатељ трошка и ефикасности',
      other: 'Наслов',
    },
  },
  schema: {
