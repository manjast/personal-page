...
summary: "A self-hosted internal knowledge assistant built in-house at Delta Holding, with Azure AD access, operator surfaces and usage + cost observability."
...
outcome: "Used by 300+ unique employees during the first month after launch, with 85%+ positive explicit feedback on thumbs-up/down responses."
metricType: "adoption"
order: 2
featured: true
services:
...
More than 300 unique employees used the assistant during its first month after
launch, and explicit thumbs-up/down feedback was more than 85% positive.
...
This case shows internal AI product work beyond the prototype layer: employee-facing
use, admin and operations surfaces, org-aware access and a deployment posture
designed to remain workable after the first demo.
