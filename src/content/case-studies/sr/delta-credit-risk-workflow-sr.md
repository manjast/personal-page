...
summary: "Систем за подршку одлучивању кредитног ризика, развијен у Делта Холдингу. Повезује јавне ризичне сигнале са интерним контекстом у препоруке за аналитичаре."
...
outcome: "Забележени исходи процеса укључивали су око 75% брже израде анализе и извештаја у односу на постојећи процес подржан RPA решењем, квалитет оцењен са 4,4/5 од стране аналитичара и више од 90% прихваћених препорука."
order: 1
featured: true
services:
  - Израда
...
Систем је радио као PoC који је користило пет аналитичара у три компаније чланице Делта Холдинга.
...
Процес је отприлике изгледао овако:
...
Најјачи резултат у овом случају био је на нивоу процеса: време израде анализе и извештаја смањено је за око **75%** у односу на постојећи процес подржан RPA решењем, квалитет је по оцени аналитичара достигао **4,4/5**, а прихватање препорука било је изнад **90%**.
