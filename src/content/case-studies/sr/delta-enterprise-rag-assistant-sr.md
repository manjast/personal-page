...
summary: "Интерни асистент за приступ знању, развијен у Делта Холдингу, са Azure AD приступом, операторским површинама и увидом у коришћење и трошкове."
...
outcome: "Више од 300 јединствених запослених користило је систем током првог месеца после пуштања у рад, уз више од 85% позитивних експлицитних оцена одговора."
metricType: "adoption"
order: 2
featured: true
services:
...
Модел рада изгледао је отприлике овако:
...
У целини сам водио архитектуру апликације и AI дела система и имплементирао асистента и административни део система око проналажења информација, приступа, сигнала квалитета и увида у рад система потребног за стварну интерну употребу.
...
Више од 300 јединствених запослених користило је асистент током првог месеца после пуштања у рад, а експлицитне оцене одговора биле су више од 85% позитивне.

Период после пуштања у рад показао је и да техничка спремност сама по себи не ствара трајно коришћење. За наставак употребе потребни су јасно власништво над производом и садржајем, као и организован начин увођења запослених у употребу система. Утицај на време процеса није мерен у првој верзији. Обухват мерења овде су коришћење током првог месеца и експлицитне повратне оцене.

## Зашто је овај случај важан

Овај случај показује интерни AI производ изван слоја прототипа: употребу за запослене, административни и оперативни део система, приступ усклађен са организационом структуром и начин увођења осмишљен да остане одржив и после првог демоа.
