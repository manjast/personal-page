---
title: "The model was rarely the problem — 3 RAG fixes"
summary: "The model was rarely the problem in 4 RAG engagements. The 3 operational gaps — eval, retrieval, cost — decided which pilots reached production."
...
heroStat:
  value: "rarely"
  label: "the model was the problem"
  attr: "Across 4 enterprise RAG engagements, 2024–2026"
---
...
<div class="blog-hero" role="figure" aria-labelledby="hero-label hero-attr">
  <span class="blog-hero__stat">rarely</span>
  <span id="hero-label" class="blog-hero__label">the model was the problem</span>
  <span id="hero-attr" class="blog-hero__attr">Across 4 enterprise RAG engagements, 2024–2026</span>
</div>
