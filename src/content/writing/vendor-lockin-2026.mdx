...
draft: false
heroStat:
  value: "Where lock-in accumulates"
...
<div class="blog-hero" role="figure" aria-labelledby="hero-label hero-attr">
  <span class="blog-hero__stat">Where lock-in accumulates</span>
...
2. **GPT-5.6 moved from a government-requested limited preview to general availability in 13 days** — availability is a lifecycle state, not a permanent feature of a model.
